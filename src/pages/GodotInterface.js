...
const GodotInterface = () => {
  return (
    <div>
      ...
      <p>At the top of the window, there is another tab named Asset Library Projects. We can search and download demo projects in the open source asset library.</p>
